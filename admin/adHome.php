     ...
     if(mysqli_num_rows($result)<1){
      ...
      <tr>
        <td><?php echo $sn ;?></td>
                ...
                <th scope="col"><button class='btn btn-success '><a style='text-decoration:none' class='link-light' href="updateform.php?EmId=<?php echo $row['EmpId']; ?>">Update</a></button>
                <a href="deletelink"  style='display:none' onclick="return confirm('Are you sure?')">Delete</a>
                <button class='btn btn-danger' ><a style='text-decoration:none' class='link-light'  href="deleteEmp.php?EmId=<?php echo $row['EmpId']; ?>" onclick="return checkDelete()">Delete</a></button>
              </th>
