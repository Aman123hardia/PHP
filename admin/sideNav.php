    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark"  style=' position: -webkit-sticky; z-index: 1;'>
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 bg-dark" style=' position: -webkit-sticky; z-index: 1;'>
				...
				<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start  pb-2 " id="menu">
					<li class='pt-4'>
						<a href="<?php echo ($check==1) ?'today.php' : 'addEmp.php'?>" class="nav-link px-0"><i class='fas fa-user-edit' style='font-size:15px'></i> <span class="d-none d-sm-inline"><?php echo ($check==1) ?"Today Task" : "Add Employee"?></span></a>
					</li>
				
				<li class='pt-2' style="<?php echo ($check==1) ?'display:none' : '' ?>">
				 <a href="tasklist.php" class="nav-link px-0"><i class='fa fa-table' style='font-size:15px'></i> <span class="d-none d-sm-inline">Task List</span></a>
				</li>

				<li class='pt-2' style="<?php echo ($check>0) ?'display:none' : '' ?>">
				 <a href="userlist.php" class="nav-link px-0"><i class='fa fa-table' style='font-size:15px'></i> <span class="d-none d-sm-inline">User List</span></a>
				</li>

				<li class='pt-2'>
					<a href="<?php echo ($check ==1) ?"tasklist.php" :"adHome.php"?>" class="nav-link px-0"><i class='fa fa-table' style='font-size:15px'></i> <span class="d-none d-sm-inline"><?php echo ($check ==1) ?"TaskList" : "Employee List"?></span></a>
				</li>
			...
			<div class="dropdown pb-4">
				...
				<a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1"
					...
					<img src="../website/profile/<?php echo $row['ProfileImage']; ?>" alt="wait" width="40" height="40" class="rounded-circle">
