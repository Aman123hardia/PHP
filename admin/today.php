...
?>
      ...
      <div class="col col-lg-12 col-xl-12">
        <div class="card rounded-3">
          <div class="card-body p-3">
            ...
            <form class="row row-cols-lg-auto g-2 justify-content-center align-items-center mb-2 pb-1" action='taskManage.php' method="post">
              <div class="col-lg-8">
  ...
  if ($conn-> query("use ems") === TRUE) 
   $today= date("Y-m-d") . "<br>";
   $record=mysqli_query($conn,"select * from `EmployeesTask` where `TaskDate`='$today'");
     $sn=1;
